...
namespace Assets.MyAssets.Scripts.Utility
{
    public class UnitSpawner : MonoBehaviour
    {
        ...
        private bool CheckSerializeFieldIsNull()
        {
            ...
            if (_mazeLayerManager == null)      { Debug.LogError("UnitSpawner: _mazeLayerManager is null");      hasNull = true; }
            if (_introCameraSequencer  == null) { Debug.LogError("UnitSpawner: _introCameraSequencer is null");  hasNull = true; }
            if (_monsterPrefab  == null)        { Debug.LogError("UnitSpawner: _monsterPrefab is null");         hasNull = true; }
            if (_playerPrefab  == null)         { Debug.LogError("UnitSpawner: _playerPrefab is null");          hasNull = true; }
            if (_keyPrefab  == null)            { Debug.LogError("UnitSpawner: _keyPrefab is null");             hasNull = true; }
            if (_goalPointPrefab  == null)      { Debug.LogError("UnitSpawner: _goalPointPrefab is null");       hasNull = true; }
        ...
        public void SpawnAll()
        {
            ...
            if (_mazeLayerManager.FogWarSystem == null) { Debug.LogError("UnitSpawner: _mazeLayerManager.FogWarSystem is Null"); return; }
            if (Player == null)                         { Debug.LogError("UnitSpawner: Player is Null");                         return; }
